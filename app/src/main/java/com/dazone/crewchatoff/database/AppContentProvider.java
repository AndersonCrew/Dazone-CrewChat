...
public class AppContentProvider extends ContentProvider {
    ...
    /* authority */
    private static final String AUTHORITY = BuildConfig.APPLICATION_ID + ".provider_db";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriKey) {
            ...
            case GET_CHAT_ROOM_KEY:
                row_deleted = db.delete(ChatRoomDBHelper.TABLE_NAME, selection, selectionArgs);
                break;
            case GET_DEPART_KEY:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriKey) {
            ...
            case GET_CHAT_ROOM_KEY:
                id = db.insertWithOnConflict(ChatRoomDBHelper.TABLE_NAME, null, values, SQLiteDatabase.CONFLICT_REPLACE);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriKey) {
            ...
            case GET_CHAT_ROOM_KEY:
                querybuilder.setTables(ChatRoomDBHelper.TABLE_NAME);
                cursor = querybuilder.query(db, null, selection, selectionArgs, null, null, sortOrder);
                cursor.setNotificationUri(getContext().getContentResolver(), uri);
                break;
            case GET_DEPART_KEY:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (uriKey) {
            ...
            case GET_MESSAGE_KEY:
                ...
                break;
            case GET_CHAT_ROOM_KEY:
                row_update = db.update(ChatRoomDBHelper.TABLE_NAME, values, selection, selectionArgs);
                break;
            case GET_DEPART_KEY:
